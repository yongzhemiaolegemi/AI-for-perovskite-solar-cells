...
class Splitter(object):
    ...
    def split(self, smiles, target=None, group=None, scaffolds=None, **params):
        ...
        if self.method in ['random']:
            ...
            # train_indices = []
            # eval_indices = []
            # for train_ids, eval_ids in self.skf:
            #     train_indices.append(train_ids.tolist())
            #     eval_indices.append(eval_ids.tolist())
            ...
            # }
            # import json
            # dir = '/data/yhm/cxy_molclr/MolCLR/data/perovskite-new/split_seed_40/splits.json'
